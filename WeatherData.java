...
public class WeatherData {
    public static void main(String[] args) {
        ...
        for (int resultRow = 0; resultRow < 3; resultRow++) {
            System.out.println("The average temperature for city " + (resultRow + 1) + " is:" + average[resultRow]);
            System.out.println("The highest temperature for city " + (resultRow + 1) + " is :" + highest[resultRow]);
        }
    }
}
